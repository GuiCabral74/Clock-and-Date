class Picker {
    ...
    onChange(callback) {
     ...
     color (){
       document.addEventListener("click", getPickedColor.currentTarget);
    }
  ...
  picker.onChange((color) => {
     let changeColorDate = document.querySelector('.data');
     let changeColorhour = document.querySelector('.hora');

    changeColorDate.style.color = `rgb(${color.r}, ${color.g}, ${color.b})`;
    changeColorhour.style.color = `rgb(${color.r}, ${color.g}, ${color.b})`;
  });
